    ...
    <div class="card card-outline card-info">
        <div class="card-header">
            ...
            <div class="card-tools">
              <RouterLink class="btn btn-primary btn-sm" :to="`/inventory/pos`"><i class="fas fa-plus"></i> Add New</RouterLink>
            </div>
        </div>
        <div class="card-body">
                  ...
                  >
                   ...
                   <template #actions="{ rowItem }">
                         ...
                         <div class="btn-group dropleft">
                            <RouterLink :to="`/inventory/sales/${rowItem.id}`"  class="btn btn-sm btn-outline-primary"  >
                            ...
                            <ul class="dropdown-menu" >
                               <li>
                                  <RouterLink class="dropdown-item" :to="`/inventory/pos/${rowItem.id}/edit`"><i class="fas fa-edit"></i> Edit</RouterLink>
